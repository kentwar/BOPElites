from tools.prediction_archive_PARSEC import prediction_archive
from acq_functions.mean import GPmean
from acq_functions.MeanxProb_Parsec import MeanxProb_Parsec
...
def calc_pred_values(exp_dir, BOP, max_n):
    ...
    for i in valrange:
        ...
        pred_archive = prediction_archive(BOP, PMoptimizer, MeanxProb_Parsec,
                                            **{'known_features' : True ,
                                               'return_pred' : True, 
                                               'PM_params' : [2**7,2**8]} )
